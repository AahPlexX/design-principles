  ...
  examples: [
    {
      ...
      good: {
        ...
        code: "article {\n  max-width: 65ch;\n  margin-inline: auto;\n  font-size: 1.125rem;\n  line-height: 1.6;\n}",
        preview:
          '<!doctype html><html lang="en"><head><meta charset="utf-8"><style>html,body{margin:0}body{font-family:Georgia,serif;color:#1a1a1a;background:#fff;padding:1rem}article{max-width:65ch;margin-inline:auto;font-size:1.0625rem;line-height:1.6}</style></head><body><article><p>A reader\'s eye travels to the end of a line, then has to find the start of the next one. Keep that trip short and the eye barely notices making it.</p></article></body></html>',
    ...
    },
    {
      ...
      good: {
        ...
        preview:
          '<!doctype html><html lang="en"><head><meta charset="utf-8"><style>html,body{margin:0}body{font-family:-apple-system,BlinkMacSystemFont,sans-serif;color:#1a1a1a;background:#fff;padding:1rem;font-size:0.875rem}table{border-collapse:collapse;width:100%}td{padding:0.75rem 1rem;line-height:1.4;border-bottom:1px solid #e2e2e2;vertical-align:top}</style></head><body><table><tr><td>Espresso Machine — Pro Series</td><td>In stock, ships in 2 days</td></tr><tr><td>Kettle</td><td>Backordered until next month</td></tr></table></body></html>',
      ...
      bad: {
        ...
        preview:
          '<!doctype html><html lang="en"><head><meta charset="utf-8"><style>html,body{margin:0}body{font-family:-apple-system,BlinkMacSystemFont,sans-serif;color:#1a1a1a;background:#fff;padding:1rem;font-size:0.875rem}table{border-collapse:collapse;width:100%}td{padding:0.25rem 0.5rem;line-height:1;border-bottom:1px solid #e2e2e2;vertical-align:top}</style></head><body><table><tr><td>Espresso Machine — Pro Series</td><td>In stock, ships in 2 days</td></tr><tr><td>Kettle</td><td>Backordered until next month</td></tr></table></body></html>',
    ...
    },
    {
      ...
      good: {
        ...
        preview:
          '<!doctype html><html lang="en"><head><meta charset="utf-8"><style>html,body{margin:0}body{font-family:-apple-system,BlinkMacSystemFont,sans-serif;color:#1a1a1a;background:#fff;padding:1rem}.eyebrow{text-transform:uppercase;letter-spacing:0.08em;font-size:0.8rem;font-weight:600;color:#5b5b66;margin:0}</style></head><body><p class="eyebrow">New feature</p></body></html>',
      ...
      bad: {
        ...
        preview:
          '<!doctype html><html lang="en"><head><meta charset="utf-8"><style>html,body{margin:0}body{font-family:-apple-system,BlinkMacSystemFont,sans-serif;color:#1a1a1a;background:#fff;padding:1rem}h2{font-size:1.1rem;font-weight:700;margin:0;line-height:1.4}</style></head><body><h2>WE\'VE SHIPPED THREE NEW FEATURES FOR YOUR TEAM</h2></body></html>',
