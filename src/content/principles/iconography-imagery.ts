...
export const iconographyImagery: Principle = {
  ...
  checklist: [
    ...
    html("Icon-only buttons have an accessible name (an <code>aria-label</code> or equivalent) even when a sighted user would recognize the icon instantly."),
