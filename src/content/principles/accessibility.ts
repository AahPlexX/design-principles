...
export const accessibility: Principle = {
  ...
  checklist: [
    ...
    html("Headings are structured in order (one <code>&lt;h1&gt;</code>, then <code>&lt;h2&gt;</code>, etc.), never skipping from <code>&lt;h1&gt;</code> straight to <code>&lt;h3&gt;</code> — screen readers let someone jump between headings the way a table of contents lets a reader jump between sections, and a skipped level breaks that shortcut."),
    ...
    html("Video has captions and audio has a transcript (WCAG 1.2.x) — not just a player with no alternative for anyone who can't hear or can't play sound."),
