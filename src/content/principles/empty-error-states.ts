...
export const emptyErrorStates: Principle = {
  ...
  checklist: [
    ...
    html("A transient failure that doesn't stop the reader from continuing what they were doing — \"Couldn't save — retry?\" — surfaces as an auto-dismissing toast or snackbar, not the same persistent, page-occupying treatment used for an error that blocks the task entirely."),
  ],
