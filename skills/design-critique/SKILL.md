...
description: Reviews a web page, component, or mockup against core design principles (typography, contrast, spacing, responsiveness, forms) and gives specific, actionable feedback. Use when a user asks for a design review, UI critique, or "does this look right" check on HTML/CSS, a screenshot, or a Figma-style description.
---
